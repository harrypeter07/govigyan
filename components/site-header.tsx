  ...
  return (
    <header
      className={cn(
        ...
        scrolled ? "bg-green-600/85 backdrop-blur-md shadow-md py-2" : "bg-green-600/70 backdrop-blur-sm py-4",
      )}
    >
      {/* Top Bar */}
      <div
        className={cn(
          ...
          scrolled ? "opacity-0 h-0 overflow-hidden" : "opacity-100 py-2 bg-white/20 backdrop-blur-sm",
        )}
      >
        <div className="container mx-auto px-4">
          <div className="flex justify-between items-center">
            <div className="text-sm text-white font-medium">Go Vigyan Anusandhan Kendra</div>
      ...
      <div className="container mx-auto px-4">
        <div className="flex justify-between items-center">
          ...
          <nav className="hidden md:flex items-center space-x-8">
            ...
            >
              <Button className="bg-amber-400 hover:bg-amber-500 text-black font-semibold ml-4">Donate Now</Button>
            </motion.div>
          </nav>
          ...
          <Sheet>
            <SheetTrigger asChild>
              <Button variant="ghost" size="icon" className="md:hidden text-white hover:bg-green-700/50">
                ...
                {navLinks.map((link) => (
                  <Link
                    ...
                    className={cn(
                      ...
                      activeLink === link.href ? "text-green-600" : "text-gray-900",
                    )}
                  >
                    {link.label}
                  </Link>
