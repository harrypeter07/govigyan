							...
							<div className="space-y-6">
								<div className="bg-amber-50 p-6 rounded-lg border-l-4 border-amber-400">
									...
									<p className="text-gray-700">
										To rekindle the age-old bond between humans and cows through
										scientific research, education, and promotion of traditional
										cow-based practices for sustainable living.
									</p>
								</div>
								<div className="bg-amber-50 p-6 rounded-lg border-l-4 border-amber-400">
									<h3 className="text-xl font-bold mb-2">Our Vision</h3>
									<p className="text-gray-700">
										A world where the sacred relationship between humans and
										cows is restored, leading to healthier communities,
										sustainable agriculture, and preservation of traditional
										knowledge.
									</p>
								</div>
							</div>
					...
					<div className="max-w-4xl mx-auto">
						<div className="relative border-l-2 border-amber-400 pl-8 pb-8">
							...
							<p className="text-gray-700 mb-8">
								Go Vigyan Anusandhan Kendra was established with the vision of
								preserving and promoting the traditional knowledge about
								indigenous cows and their products.
							</p>
						</div>
						<div className="relative border-l-2 border-amber-400 pl-8 pb-8">
							<div className="absolute w-4 h-4 bg-amber-400 rounded-full -left-[9px] top-0"></div>
							<h3 className="text-xl font-bold mb-2">
								Research Expansion (2005)
							</h3>
							<p className="text-gray-700 mb-8">
								Expanded research facilities to study the medicinal properties
								of Panchagavya and its applications in healthcare and
								agriculture.
							</p>
						</div>
						<div className="relative border-l-2 border-amber-400 pl-8 pb-8">
							...
							<p className="text-gray-700 mb-8">
								Launched comprehensive training programs for farmers,
								entrepreneurs, and healthcare practitioners on cow-based
						...
						<div className="relative pl-8">
							...
							<p className="text-gray-700">
								Today, Go Vigyan continues its mission with expanded research,
								training programs, and advocacy for indigenous cow protection
								and promotion of cow-based products.
							</p>
						</div>
					</div>
				</div>
							...
							<Card key={i} className="overflow-hidden border-none shadow-md">
								...
								<CardContent className="p-6">
									...
									<p className="text-gray-600">
										With over 20 years of experience in Ayurvedic research, Dr.
										Sharma leads our scientific studies on Panchagavya.
									</p>
								</CardContent>
							</Card>
						))}
					...
					<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
						<Card className="bg-white border-none shadow-md">
							<CardContent className="p-6 text-center">
								...
								<p className="text-gray-600">
									Dedicated to cow conservation and research
								</p>
							</CardContent>
						</Card>
						<Card className="bg-white border-none shadow-md">
							<CardContent className="p-6 text-center">
								...
								<p className="text-gray-600">
									In organic and cow-based farming practices
								</p>
							</CardContent>
						</Card>
						<Card className="bg-white border-none shadow-md">
							<CardContent className="p-6 text-center">
								...
								<p className="text-gray-600">
									Published on benefits of Panchagavya
								</p>
							</CardContent>
						</Card>
						<Card className="bg-white border-none shadow-md">
							<CardContent className="p-6 text-center">
								...
								<p className="text-gray-600">
									For contribution to sustainable agriculture
								</p>
							</CardContent>
						</Card>
					</div>
