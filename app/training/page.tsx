        ...
        <div className="container mx-auto px-4">
          ...
          <Tabs defaultValue="economy" className="max-w-5xl mx-auto">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                <div>
                  ...
                  <p className="text-gray-700 mb-6">
                    Learn how to build sustainable businesses around indigenous cows and their products. This program
                    covers entrepreneurship opportunities, product development, and market strategies.
                  </p>
                  <ul className="space-y-3">
                    <li className="flex items-start">
                      <CheckCircle className="h-5 w-5 text-green-500 mr-2 mt-0.5" />
                      <span>Product development from cow milk, urine, and dung</span>
                    </li>
                    <li className="flex items-start">
                      <CheckCircle className="h-5 w-5 text-green-500 mr-2 mt-0.5" />
                      <span>Marketing and distribution of cow-based products</span>
                    </li>
                    <li className="flex items-start">
                      <CheckCircle className="h-5 w-5 text-green-500 mr-2 mt-0.5" />
                      <span>Financial planning and sustainable business models</span>
                    </li>
                  </ul>
            ...
            <TabsContent value="farming" className="border rounded-lg p-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                <div>
                  <h3 className="text-2xl font-bold mb-4">Organic Farming - सेंद्रिय खेती</h3>
                  <p className="text-gray-700 mb-6">
                    Learn traditional and modern techniques of organic farming using cow-based inputs. This program
                    covers soil health, crop rotation, and natural pest management.
                  </p>
                  <ul className="space-y-3">
                    <li className="flex items-start">
                      <CheckCircle className="h-5 w-5 text-green-500 mr-2 mt-0.5" />
                      <span>Soil preparation using cow dung and other organic matter</span>
                    </li>
                    <li className="flex items-start">
                      <CheckCircle className="h-5 w-5 text-green-500 mr-2 mt-0.5" />
            ...
            <TabsContent value="vermicompost" className="border rounded-lg p-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                <div>
                  <h3 className="text-2xl font-bold mb-4">Vermicompost - केंचुआ खेती</h3>
                  <p className="text-gray-700 mb-6">
                    Master the art of vermicomposting using earthworms and cow dung. Learn how to create nutrient-rich
                    compost for your plants and crops.
                  </p>
                  <ul className="space-y-3">
                    <li className="flex items-start">
                      <CheckCircle className="h-5 w-5 text-green-500 mr-2 mt-0.5" />
                ...
                <div className="relative h-[300px] rounded-lg overflow-hidden">
                  <Image src="/placeholder.svg?height=300&width=400" alt="Vermicompost" fill className="object-cover" />
                </div>
              </div>
            </TabsContent>
            ...
            <TabsContent value="fertilizer" className="border rounded-lg p-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                <div>
                  <h3 className="text-2xl font-bold mb-4">Fertilizer - अमृत पानी -उर्वरक</h3>
                  <p className="text-gray-700 mb-6">
                    Learn to prepare natural fertilizers using cow urine, dung, and other organic materials to enhance
                    soil fertility and plant growth.
                  </p>
                  <ul className="space-y-3">
                    <li className="flex items-start">
                      <CheckCircle className="h-5 w-5 text-green-500 mr-2 mt-0.5" />
                      <span>Preparation of Jeevamrut and other liquid fertilizers</span>
                    </li>
                    <li className="flex items-start">
                      <CheckCircle className="h-5 w-5 text-green-500 mr-2 mt-0.5" />
            ...
            <TabsContent value="pestcontrol" className="border rounded-lg p-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                <div>
                  <h3 className="text-2xl font-bold mb-4">Keet Niyantrak - कीट नियंत्रकरक</h3>
                  <p className="text-gray-700 mb-6">
                    Learn to prepare natural pest control solutions using cow urine, neem, and other botanical
                    ingredients to protect crops without harmful chemicals.
                  </p>
                  <ul className="space-y-3">
                    <li className="flex items-start">
                      <CheckCircle className="h-5 w-5 text-green-500 mr-2 mt-0.5" />
                      <span>Preparation of cow urine-based pest repellents</span>
                    </li>
                    <li className="flex items-start">
                      <CheckCircle className="h-5 w-5 text-green-500 mr-2 mt-0.5" />
              ...
              <CardContent className="p-6">
                <div className="flex items-center mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Gondia District, Maharashtra</p>
                  </div>
                </div>
              ...
              <CardContent className="p-6">
                <div className="flex items-center mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Karanja Ghadge, Wardha</p>
                  </div>
                </div>
                <p className="text-gray-700 italic">
