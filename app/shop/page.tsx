  ...
  return (
    <PageTransition>
                ...
                <CardContent className="p-4">
                  <div className="flex items-center mb-2">
                    {Array.from({ length: 5 }).map((_, i) => (
                      <Star
                        key={i}
                        className={`h-4 w-4 ${i < Math.floor(product.rating) ? "text-green-600 fill-green-600" : i < product.rating ? "text-green-600 fill-green-600" : "text-gray-300"}`}
                      />
                    ))}
      ...
      <section className="py-16 bg-gray-50" data-scroll-section>
        <div className="container mx-auto px-4">
          <SectionHeading title="Shop by Category" subtitle="Browse our wide range of cow-based products" centered />
                    ...
                    <CardContent className="p-4">
                      <div className="flex items-center mb-2">
                        {Array.from({ length: 5 }).map((_, i) => (
                          <Star
                            key={i}
                            className={`h-4 w-4 ${i < 4 ? "text-green-600 fill-green-600" : "text-gray-300"}`}
                          />
                        ))}
                        <span className="text-sm text-gray-600 ml-1">(4.0)</span>
                      </div>
                      <h3 className="font-bold mb-1">Product Name {index + 1}</h3>
                      <div className="flex justify-between items-center">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                {Array.from({ length: 8 }).map((_, index) => (
                  <Card key={index} className="overflow-hidden border-none shadow-md group">
                    <div className="relative h-64 overflow-hidden">
                      <Image
                        src={`/placeholder.svg?height=300&width=300&text=Health ${index + 1}`}
                    ...
                    <CardContent className="p-4">
                      ...
                      <h3 className="font-bold mb-1">Health Product {index + 1}</h3>
                      <div className="flex justify-between items-center">
                        <span className="font-bold text-green-600">₹{Math.floor(Math.random() * 500) + 100}</span>
                        <Button size="sm" className="bg-green-600 hover:bg-green-700 text-white">
                          <ShoppingCart className="h-4 w-4 mr-1" /> Add
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                {Array.from({ length: 8 }).map((_, index) => (
                  <Card key={index} className="overflow-hidden border-none shadow-md group">
                    <div className="relative h-64 overflow-hidden">
                      <Image
                        src={`/placeholder.svg?height=300&width=300&text=Personal ${index + 1}`}
                    ...
                    <CardContent className="p-4">
                      ...
                      <h3 className="font-bold mb-1">Personal Care {index + 1}</h3>
                      <div className="flex justify-between items-center">
                        <span className="font-bold text-green-600">₹{Math.floor(Math.random() * 500) + 100}</span>
                        <Button size="sm" className="bg-green-600 hover:bg-green-700 text-white">
                          <ShoppingCart className="h-4 w-4 mr-1" /> Add
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                {Array.from({ length: 8 }).map((_, index) => (
                  <Card key={index} className="overflow-hidden border-none shadow-md group">
                    <div className="relative h-64 overflow-hidden">
                      <Image
                        src={`/placeholder.svg?height=300&width=300&text=Home ${index + 1}`}
                    ...
                    <CardContent className="p-4">
                      ...
                      <h3 className="font-bold mb-1">Home & Garden {index + 1}</h3>
                      <div className="flex justify-between items-center">
                        <span className="font-bold text-green-600">₹{Math.floor(Math.random() * 500) + 100}</span>
                        <Button size="sm" className="bg-green-600 hover:bg-green-700 text-white">
                          <ShoppingCart className="h-4 w-4 mr-1" /> Add
