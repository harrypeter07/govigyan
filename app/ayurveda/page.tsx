...
import { ArrowRight, CheckCircle, Droplet, Leaf, Milk, Sun, Wind } from "lucide-react"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-gray-700 mb-6">
                Panchagavya is a blend of five products obtained from cows - milk, curd, ghee, urine, and dung. This
                powerful combination has been used for centuries in traditional Ayurvedic medicine for its therapeutic
            ...
            <div className="relative h-[400px] rounded-lg overflow-hidden">
              <Image src="/placeholder.svg?height=400&width=600" alt="Panchagavya" fill className="object-cover" />
            </div>
          </div>
        </div>
      </section>
            ...
            {[
              {
                ...
                description: "A medicated ghee preparation used for improving digestion, memory, and overall health.",
                uses: ["Digestive disorders", "Memory enhancement", "Immune support"],
              },
              {
                title: "Cow Urine Ark",
                description: "Distilled cow urine with powerful antimicrobial and immune-boosting properties.",
                uses: ["Liver detoxification", "Skin conditions", "Immune enhancement"],
              },
              {
                title: "Panchagavya Soap",
                description: "Natural soap made with cow milk and ghee for gentle cleansing and skin nourishment.",
                uses: ["Daily cleansing", "Skin nourishment", "Treatment of minor skin issues"],
              },
              {
                title: "Panchagavya Hair Oil",
                description: "Herbal oil infused with Panchagavya for hair health and scalp conditions.",
                uses: ["Hair strengthening", "Scalp health", "Premature graying"],
              },
              {
                title: "Panchagavya Skin Cream",
                description: "Nourishing cream for various skin conditions and general skin health.",
                uses: ["Dry skin", "Minor wounds", "Skin irritations"],
              },
              {
                title: "Panchagavya Tooth Powder",
                description: "Natural tooth powder for oral hygiene and gum health.",
              ...
              <Card key={index} className="border-none shadow-md overflow-hidden">
                <div className="relative h-48">
                  <Image
                    src={`/placeholder.svg?height=200&width=400&text=${product.title}`}
                    alt={product.title}
                    fill
                ...
                <CardContent className="p-6">
                  ...
                  <h4 className="font-semibold text-green-700 mb-2">Common Uses:</h4>
                  ...
                  <Button className="mt-4 w-full bg-green-600 hover:bg-green-700 text-white">View Product</Button>
                </CardContent>
              </Card>
            ))}
          </div>
          ...
          <div className="max-w-4xl mx-auto">
            <Card className="border-none shadow-md mb-8">
              <CardContent className="p-8">
                <h3 className="text-2xl font-bold mb-4">Our Research Initiatives</h3>
                <p className="text-gray-700 mb-6">
                  At Go Vigyan Anusandhan Kendra, we are committed to scientifically validating the traditional
                  knowledge of Panchagavya through rigorous research. Our team of scientists and Ayurvedic practitioners
                  work together to study the efficacy, safety, and applications of Panchagavya products in modern
                  healthcare.
                </p>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="bg-amber-50 p-4 rounded-lg">
                    ...
                    <p className="text-sm text-gray-700">
                      Research on the antimicrobial properties of cow urine against various pathogens, including
                  ...
                  <div className="bg-amber-50 p-4 rounded-lg">
                    ...
                    <p className="text-sm text-gray-700">
                      Studies on how Panchagavya preparations enhance immune function and regulate inflammatory
                  ...
                  <div className="bg-amber-50 p-4 rounded-lg">
                    ...
                    <p className="text-sm text-gray-700">
                      Research on the free radical scavenging activity of various Panchagavya components and their
                      potential in preventing oxidative stress.
                    </p>
                  </div>
                  <div className="bg-amber-50 p-4 rounded-lg">
                    <h4 className="font-bold mb-2">Clinical Applications</h4>
                    <p className="text-sm text-gray-700">
                      Clinical trials and case studies on the efficacy of Panchagavya formulations in treating various
                      health conditions.
                    </p>
                  </div>
                </div>
