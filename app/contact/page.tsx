                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">
                        Kamdhenu Bhavan, Pt. Baccharaj Vyas Square, Chitar Oli, Mahal, Nagpur, India
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto">
            <div className="space-y-6">
              ...
              <Card className="border-none shadow-sm">
                <CardContent className="p-6">
                  <h3 className="text-lg font-bold mb-2">How can I support your cow conservation efforts?</h3>
                  <p className="text-gray-700">
                    You can support our efforts by donating, volunteering, purchasing our cow-based products, or
                    spreading awareness about our mission. Every contribution helps us continue our work in cow
              ...
              <Card className="border-none shadow-sm">
                <CardContent className="p-6">
                  <h3 className="text-lg font-bold mb-2">Do you ship your products internationally?</h3>
                  <p className="text-gray-700">
                    Yes, we ship to select international destinations. International shipping times and costs vary by
                    location. Please contact us for specific information about shipping to your country.
                  </p>
                </CardContent>
              </Card>
            </div>
